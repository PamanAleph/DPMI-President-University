...
import Review from "@/components/admin/setup/create/Review";
...
const steps = [
  {
    id: "01",
    name: "Setup Details",
    description: "Enter Setup title and content",
    status: "current",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    description: "Enter Question title and content",
    status: "upcoming",
  },
  {
    id: "04",
    name: "Review & Create",
    description: "Review your assessment form and create",
    status: "upcoming",
  },
];
...
export default function Page() {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2:
        return <QuestionDetails onNext={handleNext}/>;
      case 3:
        return <Review />;
      default:
        return null;
